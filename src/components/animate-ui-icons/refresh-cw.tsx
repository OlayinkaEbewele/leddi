...
const animations = {
  rotate: {
    group: {
      initial: { rotate: 0, transition: { type: 'spring', stiffness: 100, damping: 25 } },
      animate: { rotate: 360, transition: { type: 'spring', stiffness: 100, damping: 25 } },
    },
    path1: {},
    path2: {},
    path3: {},
...
export function RefreshCwIcon(props: RefreshCwProps) {
  return <IconWrapper icon={IconComponent} animation="rotate" {...props} />;
}
